(function (require$$0$1, Stream, require$$0, buffer, util) {
	'use strict';
	...
	*/
	...
	if (!arrayBufferNative) {
	  ...
	  /* eslint-enable no-new -- required for testing */
	    ...
	    for (var keys$3 = getOwnPropertyNames$2(NativeArrayBuffer$1), j$1 = 0, key$2; keys$3.length > j$1;) {
	      if (!((key$2 = keys$3[j$1++]) in $ArrayBuffer)) {
	...
	if (descriptors && !has$1(TypedArrayPrototype, TO_STRING_TAG)) {
	  ...
	  defineProperty$4(TypedArrayPrototype, TO_STRING_TAG, { get: function () {
	...
	var FORCED$8 = NEGATIVE_ZERO$1 || !STRICT_METHOD$4;
	...
	var FORCED$4 = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$3;
	...
	if (isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
	  ...
	  for (var keys$2 = descriptors ? getOwnPropertyNames$1(NativeNumber) : (
	    ...
	    if (has$1(NativeNumber, key$1 = keys$2[j]) && !has$1(NumberWrapper, key$1)) {
	...
	inherits(Transform$1, _stream_duplex);
	...
	createCommonjsModule(function (module) {
	  ...
	  tXml.filter = function (children, f) {
	    var out = [];
	    children.forEach(function (child) {
	      if (_typeof(child) === 'object' && f(child)) out.push(child);
	...
	[fieldTags.BitsPerSample, fieldTags.ExtraSamples, fieldTags.SampleFormat, fieldTags.StripByteCounts, fieldTags.StripOffsets, fieldTags.StripRowCounts, fieldTags.TileByteCounts, fieldTags.TileOffsets];
	var fieldTypeNames = {
	  0x0001: 'BYTE',
	  0x0002: 'ASCII',
	  0x0003: 'SHORT',
	...
	invert(fieldTypeNames); // config variables
	var _binBE = {
	...
	var DummyLogger = /*#__PURE__*/function () {
	  function DummyLogger() {
	    _classCallCheck$1(this, DummyLogger);
	  }

	  _createClass$1(DummyLogger, [{
	    key: "log",
	    value: function log() {}
	  }, {
	    key: "info",
...
}(require$$0$1, Stream, require$$0, buffer, util));
